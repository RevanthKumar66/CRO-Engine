  ...
  const recommendations: Recommendation[] = [
    {
      ...
      rationale: 'Mobile shoppers must scroll past large text description blocks to execute the primary conversion. Keeping the conversion trigger immediately reachable yields up to 15% increases in click-through rates.',
      actionSteps: [
    ...
    },
    {
      ...
      rationale: 'Buyer friction rises at high-risk steps like payment routing. Visual reassurance triggers lower basket abandonment rates.',
      actionSteps: [
    ...
    },
    {
      ...
      finding: 'Homepage headline is focused on company description rather than client value proposition.',
      rationale: 'Bounce rates double when visitors fail to understand what benefits the brand offers in the first 3 seconds.',
      actionSteps: [
    ...
    },
    {
      ...
      rationale: 'A 100ms load delay lowers conversion rates. Keeping storefront image grids optimized improves layout transitions.',
      actionSteps: [
