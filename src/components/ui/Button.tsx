  ...
  "inline-flex items-center justify-center rounded-md text-xs font-semibold tracking-tight transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-violet focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 cursor-pointer border border-transparent select-none",
  {
    variants: {
      variant: {
        ...
        secondary: "bg-bg-secondary text-text-primary border-border-muted hover:bg-slate-100/80 active:bg-slate-200/50",
        outline: "bg-transparent text-text-secondary border-border-muted hover:bg-slate-50 hover:text-text-primary",
        ghost: "text-text-secondary hover:text-text-primary hover:bg-slate-100/60 active:bg-slate-200/40",
