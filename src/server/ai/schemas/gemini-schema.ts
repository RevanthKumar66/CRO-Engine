    ...
    recommendations: {
      ...
      items: {
        ...
        properties: {
          ...
          evidence: {
            type: Type.STRING,
            description: 'Specific HTML selector or text elements where the issue was found.',
          },
          rationale: {
            type: Type.STRING,
            description: 'E-commerce psychology or CRO justification.',
          },
          actionSteps: {
            type: Type.ARRAY,
          ...
          priority: {
            type: Type.INTEGER,
            description: '1 = Critical/Quick Win, 2 = High, 3 = Medium, 4 = Low',
          },
        },
        required: [
          'id',
